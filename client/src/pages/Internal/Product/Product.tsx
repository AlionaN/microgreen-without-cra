    ...
    <AppLayout>
      <div className={styles.product}>
        ...
        <div className={styles.productInfo}>
          ...
          {product?.amount && <div className={styles.productAmount}>Size: {product.amount}</div>}
          <input type="number" className={styles.productQuantity} value={productQuantity} onChange={(e) => onQuantityChange(e)} />
